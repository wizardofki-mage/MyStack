...
- The MyStack.java file contains all of the internal classes necessary to run it, and all of these classes are in one file because this was the requirement for the assignment submission.
...
## Screenshots
![A screen capture of the output of the MyStack program.](MyStackProgramRun2.png)
